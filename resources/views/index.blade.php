        ...
        <div class="interface" id="interface">
            <div id="1" class="hidden">
                ...
                <h2>新增子BM</h2>
                    ...
                    <label for="parentBmId">父BM ID: (預設:1091332491850683)</label>
                    ...
                    <input type="text" id="bmVertical" name="bmVertical" required><br><br>
...
<div id="bmList">
    <table id="bmTable">
        <thead>
            <tr>
                <th>設置好新額度之後請按下"左下方"按鈕確認，請勿按到刪除</th>
            </tr>
        </thead>
        <tbody>
           <div id="bmList">
        ...
        <tbody>
            @foreach ($businessManagers as $bm)
                <tr>@csrf
                    ...
                    <td>
                        <button type="button" onclick="updateBudget({{ $bm->id }})">確認修改</button>
    ...
    <button onclick="updateBudgets()">確認提交修改</button>
</div>
